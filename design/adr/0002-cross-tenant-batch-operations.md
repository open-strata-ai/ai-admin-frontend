...
This ADR solidifies "cross-tenant batch operations" into architectural decision records and incorporates them into `design/adr/` for continuous tracking. This issue stems from the `design/DESIGN.md` §11 open issue and is still open.
